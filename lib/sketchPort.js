...
//             TODO: DOC EXCEPTION TO THAT RULE FOR PRIMITIVE TYPES
...
OutputPort.prototype._updateValue = function() {
   if (AT.isPrimitive(this.typename)) {
...
OutputPort.prototype._getWrappedValue = function() {
   let v = this.func();
   if (v instanceof AT.typeNamed(this.typename)) {
      return v;
   }
   else {
      return new (AT.typeNamed(this.typename))(v);
   }
}
