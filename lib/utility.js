...
// GET AND SET STATE DATA VIA THE PERSISTENT SERVER.
   ...
   function Server() {
      ...
      this.connectSocket = function() {
         // LOAD THE PROTO FOR HEAD TRACKING
         this.Head = this.initProtoBuf();
         ...
         this.socket.onmessage = function(event) {
            // MESSAGE FROM SERVER SHOULD BE A HEAD PROTO
            _this.headBuffer = _this.Head.decode(event.data);
         };
         return this.socket;
      };
      ...
      // THIS WILL STORE THE STATE OF THE HEAD PROTO FROM THE SERVER
      this.headBuffer = 0;
      ...
      this.initProtoBuf = function() {
        ...
        var Head = ProtoBuf.loadProtoFile("server/head.proto").build("Chalktalk").Head;
        return Head;
      };
   }
/*
