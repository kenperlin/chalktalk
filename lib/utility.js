   ...
   function Server() {
      ...
      this.connectSocket = function() {
         ...
         this.socket.onmessage = function(event) {
            ...
            if (obj.eventType !== undefined && obj.eventType.indexOf("mouse") != -1) {
               switch(obj.eventType) {
                  case "onmousedown":
                     events_canvas.onmousedown(obj.event);
                     break;
                  case "onmouseup":
                     events_canvas.onmouseup(obj.event);
                     break;
                  case "onmousemove":
                     events_canvas.onmousemove(obj.event);
                     break;
               }
            }
