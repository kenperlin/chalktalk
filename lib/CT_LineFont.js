CT.lineFont = (function() {
   ...
   ['&',[
      [[.6,-.5],1,[0,-1.1],-1.9,[-.7,-.5],-3.5,[.46,.49],[1.36,-1.09]],
   ]],
   ['\'',[
      [[.15,1],[-.15,.5]],
   ]],
   ...
   ['2',[
      [[-.6,.4],2,[0,1],1,[0,-.2],-1,[-.6,-.8],[.6,-1],[1.8,-1]],
   ]],
   ['3',[
      [[-.6,1],[.6,1],[0,.2],-2.8,[.7,-.4]],
   ]],
   ...
   ['@',[
      [[0,-1],-3,[-.8,0],[-.8,-.3],2,[-1,-.5],[-1.2,0],4,[-1.6,-.6]],
   ]],
   ['A',[
      [[-.7,-1],[0,1],[.7,-1]],
      [[-.35,0],[.35,0]],
   ...
   ['{',[
      [[.4,1.2],-1,[0,.8],1,[.4,0],-1,[.8,-.8],1,[.4,-1.2]],
   ]],
   ['|',[
      [[0,1],[0,-1]],
   ]],
   ...
   ['\u00b2',[
      [[-.7,1.7],2,[-.4,2],1,[-.4,1.4],-1,[-.7,1.1],[-.1,1],[.5,1]],
   ]],
   ['\u00b3',[
