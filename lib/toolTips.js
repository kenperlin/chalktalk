   ...
   var toolTipSimpleSketchHelp = [
      ...
      ['Click here',
       ...
       'to lock/unlock the sketch.',
       ,
       'While locked, the sketch',
       'ignores any clicks.',
      ].join('\n'),
   ...
   var toolTipSketchHelp = [
      ...
      ['Click here, then',
       ...
       'Click again when done.',
       ,
       'Or click then drag down',
       'to lock/unlock sketch.',
      ].join('\n'),
   ...
   function drawToolTip() {
	 ...
	 if (isHover())
      ...
      if (mode > 0) {
	    ...
	    if (mode == 1) {
	       ...
	       if (isSimpleSketch(sk()) && toolTipSimpleSketchHelp[i] !== undefined)
	          txt = toolTipSimpleSketchHelp[i];
	       if (txt !== undefined) {
	 ...
	 if (mode == 2 && isSimpleSketch(sk()) && sk().isGlyphable)
