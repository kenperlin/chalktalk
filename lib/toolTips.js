      ...
      if (mode === 3) {
         ...
         for (let i = 0; i < nsk(); i++) {
            ...
            for (let i = 0; i <= curr.inputs.numPorts(); i++) {
               let input;
               let checkDynamicInput = (i === curr.inputs.numPorts());
               if (checkDynamicInput) {
                  input = curr.inputs._dynamicPortTemplate;
                  if (input === undefined) { continue; }
               }
               else {
                  input = curr.inputs.port(i);
               }
               let inputTypeString = "";
