...
var imageLibrary_scaleImage = 0.85;
...
function imageLibrary_createCanvasImage() {
   ...
   for (i = 0 ; i < imageLibrary_images.length ; i++) {
	 ...
	 var _fh = fontStyle.isSmall ? fh/2 : fh;
         ...
         context.fillStyle = backgroundColor == 'black' ? scrimColor(0.7) : 'black';
   ...
   if (isDef(window.imageLibrary_canvasImage) && imageLibrary_isShowingLibrary) {
	 ...
	 var scale = imageLibrary_scaleImage;
         ...
         if (value instanceof Image)
            ...
            context.fillStyle = backgroundColor == 'black' ? scrimColor(0.5) : 'black';
