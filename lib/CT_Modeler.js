...
CT.Cone         = function(n)          { this.init('Cone');
                                         this.add(new CT.OpenCone(n));
                                         this.add(new CT.Disk(n)).translate(0,0,-1);                     }; CT.Cone.prototype         = new CT.Object;
CT.Cube         = function()           { this.init('Cube', new CT.ShapePolyhedron(CT.cubeVertices,
                                                                                  CT.cubeFaces))         }; CT.Cube.prototype         = new CT.Object;
CT.Cylinder     = function(n)          { this.init('Cylinder');
...
CT.Disk         = function(n)          { this.init('Disk', new CT.ShapeDisk(def(n,16)));                 }; CT.Disk.prototype         = new CT.Object;
CT.Extruded     = function(nu,nv,fu,fv){ this.init('Extruded', new CT.ShapeExtruded(nu,nv,fu,fv));       }; CT.Extruded.prototype     = new CT.Object;
CT.Node         = function()           { this.init('Node');                                              }; CT.Node.prototype         = new CT.Object;
CT.OpenCone     = function(n)          { this.init('OpenCone', new CT.ShapeOpenCone(def(n,16)));         }; CT.OpenCone.prototype     = new CT.Object;
CT.OpenCylinder = function(n)          { this.init('OpenCylinder', new CT.ShapeOpenCylinder(def(n,16)))  }; CT.OpenCylinder.prototype = new CT.Object;
CT.Parametric   = function(nu,nv,f)    { this.init('Parametric', new CT.ShapeParametric(nu,nv,f));       }; CT.Parametric.prototype   = new CT.Object;
CT.Polyhedron=function(v,f,n,uv,nf,uf) { this.init('Polyhedron', new CT.ShapePolyhedron(v,f,n,uv,nf,uf));}; CT.Polyhedron.prototype   = new CT.Object;
CT.Revolved     = function(nu,nv,f)    { this.init('Revolved', new CT.ShapeRevolved(nu,nv,f));           }; CT.Revolved.prototype     = new CT.Object;
CT.Sphere       = function(m,n,a)      { this.init('Sphere', new CT.ShapeSphere(m,n,a));                 }; CT.Sphere.prototype       = new CT.Object;
CT.Square       = function()           { this.init('Square', new CT.ShapeSquare());                      }; CT.Square.prototype       = new CT.Object;
CT.Torus        = function(m,n,r)      { this.init('Torus', new CT.ShapeTorus(m,n,r));                   }; CT.Torus.prototype        = new CT.Object;
