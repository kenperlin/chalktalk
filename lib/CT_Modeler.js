...
CT.Scene.prototype = {
   ...
   getStereo: function()      { return def(this._stereo); },
...
CT.Object.prototype = {
   ...
   setMetal         : function(r,g,b,p)  { return this.setPhong([r/80,g/80,b/80, r/20,g/20,b/20, r,g,b, def(p,7)]); },
   setNormalMap     : function(fileName) { this._textureFile1 = fileName; return this; },
   setPhong         : function(phong)    { this._phong = phong; return this; },
   setTexture       : function(fileName) { this._textureFile0 = fileName; return this; },
