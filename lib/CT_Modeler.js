   ...
   this._vertices = (function() {
      function addTriangle(a, b, c, p, au,av, bu,bv, cu,cv) {
	    ...
	    p = 0;
         ...
         if (ns) {
            vertices.push(ax,ay,az, U[0],U[1],U[2], V[0],V[1],V[2], ns[3 * a],ns[3 * a + 1],ns[3 * a + 2], u[0],v[0], 0,0);
            vertices.push(bx,by,bz, U[0],U[1],U[2], V[0],V[1],V[2], ns[3 * b],ns[3 * b + 1],ns[3 * b + 2], u[1],v[1], 0,0);
            vertices.push(cx,cy,cz, U[0],U[1],U[2], V[0],V[1],V[2], ns[3 * c],ns[3 * c + 1],ns[3 * c + 2], u[2],v[2], 0,0);
         }
         else {
            vertices.push(ax,ay,az, U[0],U[1],U[2], V[0],V[1],V[2], W[0],W[1],W[2], u[0],v[0], 0,0);
            vertices.push(bx,by,bz, U[0],U[1],U[2], V[0],V[1],V[2], W[0],W[1],W[2], u[1],v[1], 0,0);
            vertices.push(cx,cy,cz, U[0],U[1],U[2], V[0],V[1],V[2], W[0],W[1],W[2], u[2],v[2], 0,0);
         }
      }
