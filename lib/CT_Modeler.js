...
(CT.ShapeDisk = function(n) { 
  ...
  this.surfaceRevolved(n,1,function(t) { return [t+.001,0]; }); }).prototype = new CT.Shape;
...
(CT.ShapeOpenCylinder = function(n) {
  ...
  this.surfaceRevolved(n,2,function(t) { return [1,2*t-1]; }); }).prototype = new CT.Shape;
...
CT.Cylinder = function(n)       { this.typeName = "OpenCylinder"; this.init(new CT.ShapeOpenCylinder(n));      }; CT.Cylinder.prototype = new CT.Object;
CT.Disk         = function(n)       { this.typeName = "Disk"; this.init(new CT.ShapeDisk(n));              }; CT.Disk.prototype         = new CT.Object;
...
CT.OpenCylinder = function(n)       { this.typeName = "OpenCylinder"; this.init(new CT.ShapeOpenCylinder(n));      }; CT.OpenCylinder.prototype = new CT.Object;
...
CT.Polyhedron   = function(vs,fs,ns){ this.typeName = "Polyhedron"; this.init(new CT.ShapePolyhedron(vs,fs,ns)); }; CT.Polyhedron.prototype   = new CT.Object;
