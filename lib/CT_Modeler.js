...
(CT.ShapeDisk         = function(n) { this.surfaceRevolved(n,1,function(t) { return [t,0]; }); }).prototype = new CT.Shape;
...
CT.Disk         = function(n)         { this.init(new CT.ShapeDisk(def(n,16)));        }; CT.Disk.prototype         = new CT.Object;
...
CT.OpenCylinder = function(n)         { this.init(new CT.ShapeOpenCylinder(def(n,16))) }; CT.OpenCylinder.prototype = new CT.Object;
CT.Parametric   = function(nu,nv,f)   { this.init(new CT.ShapeParametric(nu,nv,f));    }; CT.Parametric.prototype   = new CT.Object;
CT.Polyhedron=function(v,f,n,uv,nf,uf){ this.init(new CT.ShapePolyhedron(v,f,n,uv,nf,uf));};CT.Polyhedron.prototype = new CT.Object;
