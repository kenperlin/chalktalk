...
,'   vec3 t = fract(P);'
,'   P = t * f;'
,'   return mix( mix( mix( noise( P + vec3( f , f , f ) ),'
,'                         noise( P + vec3( 0., f , f ) ), t.x),'
,'                    mix( noise( P + vec3( f , 0., f ) ),'
,'                         noise( P + vec3( 0., 0., f ) ), t.x), t.y),'
,'               mix( mix( noise( P + vec3( f , f , 0.) ),'
,'                         noise( P + vec3( 0., f , 0.) ), t.x),'
,'                    mix( noise( P + vec3( f , 0., 0.) ),'
,'                         noise( P                     ), t.x), t.y), t.z) / f;'
,'}'
