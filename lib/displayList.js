   ...
   function _sendPolyhedronData(mode, type, sketchID, submeshIdx, x, y, z, rx, ry, rz, sc, argList) {
   ...
   function _sendCubeData(mode, type, sketchID, submeshIdx, x, y, z, rx, ry, rz, sc) {
      // count means #number ofuint16s, so a float gets a count of 2
   ...
   function _sendSquareData(mode, type, sketchID, submeshIdx, x, y, z, rx, ry, rz, sc) {
      // count means #number ofuint16s, so a float gets a count of 2
      const size = HEADER_SIZE_IN_INT16 + TRANSFORM_SIZE_IN_INT16;
      _sendMeshDataHeader(size, mode, type, sketchID, submeshIdx);
   ...
   function _sendSphereData(mode, type, sketchID, submeshIdx, x, y, z, rx, ry, rz, sc, argList) {
   ...
   function _sendTorusData(mode, type, sketchID, submeshIdx, x, y, z, rx, ry, rz, sc, argList) {
      // count means #number ofuint16s, so a float gets a count of 2
      const size = HEADER_SIZE_IN_INT16 + TRANSFORM_SIZE_IN_INT16 + 2;
      _sendMeshDataHeader(size, mode, type, sketchID, submeshIdx);
   ...
   function _sendOpenCylinderData(mode, type, sketchID, submeshIdx, x, y, z, rx, ry, rz, sc, argList) {
      // count means #number ofuint16s, so a float gets a count of 2
   ...
   function _sendDiskData(mode, type, sketchID, submeshIdx, x, y, z, rx, ry, rz, sc, argList) {
      // count means #number ofuint16s, so a float gets a count of 2
      const size = HEADER_SIZE_IN_INT16 + TRANSFORM_SIZE_IN_INT16 + 1;
      _sendMeshDataHeader(size, mode, type, sketchID, submeshIdx);
   ...
   function _sendMeshData(mode, type, sketchID, submeshIdx, x, y, z, rx, ry, rz, sc, argList) {

      const fn = shapeTypeToFunction[type];
      if (fn) {

         fn(mode, shapeTypeToNum[type], sketchID, submeshIdx, x, y, z, rx, ry, rz, sc, argList);
      }
      else {
