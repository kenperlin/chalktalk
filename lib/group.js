...
Group.prototype = {
    ...
    isOnCurrentPage: function() {
        return (this.sketchPageIndex == pageIndex);
    },
    checkOnCurrentPage: function() {
    ...
    create: function() {
        ...
        this.sketchPageIndex = pageIndex;
    },
    ...
    translateUnconditionally : function(dx, dy) {
        this.xlo += dx;
        this.ylo += dy;
        this.xhi += dx;
        this.yhi += dy;
    ...
    update: function(elapsed) {
        ...
        window.PUSHED_sketch_zOffset = this._zOff;
