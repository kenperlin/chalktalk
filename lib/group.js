...
Group.prototype = {
   ...
   _drawShape : function(alpha) {
      ...
      var shapeHash = this.xlo + ' ' + this.ylo + ' ' + this.xhi + ' ' + this.ylo;
      if (shapeHash != this.shapeHash) {
         this.shape = [].concat(createRaggedLine(this.xlo, this.ylo, this.xhi, this.ylo))
                        .concat(createRaggedLine(this.xhi, this.ylo, this.xhi, this.yhi))
                        .concat(createRaggedLine(this.xhi, this.yhi, this.xlo, this.yhi))
                        .concat(createRaggedLine(this.xlo, this.yhi, this.xlo, this.ylo));
         this.shapeHash = shapeHash;
      }

      color('rgba(0,128,255,' + (0.2 * alpha) + ')');
/*
      fillRect(this.xlo, this.ylo, this.xhi - this.xlo, this.yhi - this.ylo);
*/
      fillPolygon(this.shape);
   },
