...
/////////////////////////////////////////////////////////////////////
   ...
   function drawPossibleLink(s, x, y) {
      ...
      if (s.linkCurve != null) {
         ...
         var xy = s.portXY_DEPRECATED_PORT_SYSTEM(outPort);
         arrow(xy[0], xy[1], x, y);
      }
   }
         ...
         if (isAudiencePopup() || ! isShowingOverlay()) {
            ...
            if (sketchDragMode == 4) {
               ...
               if (isMouseOverBackground || i < 0) {
                  ...
                  let outputType = null;
                  if (outSketch.output instanceof OutputPort) {
                     outputType = outSketch.output.typename;
                  }
                  else if (typeof(outSketch.output) === "function") {
                     outputType = "Unknown";
                  }
