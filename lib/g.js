   ...
   function registerSketch(type) {
      ...
      for (n = 0 ; n < sk().labels.length ; n++) {
         ...
         if (status == 0) {
            ...
            names.push(registerGlyph(code, glyphTrace, sk().labels[n], sk().tags));
         }
      }
...
/////////////////////////////////////////////////////////////////////
   ...
   function registerGlyph(name, strokes, indexName, tags) {
...
*/
   ...
   function addSketch(sketch) {
      ...
      if (sketch.tags.length == 0 && sketch.tag)
         sketch.tags.push(sketch.tag);
