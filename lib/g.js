...
//////////////////////////////////////////////////////////////////////////////////
   ...
   function _g_beginPath() {
      _path = [];
   }

   function _g_pathTo(p, isLine) {
   ...
   function _g_stroke() {
      ...
      if (isAnimatingView) {
         ...
         for (var i = 0 ; i < _path.length ; i++)
            if (! _path[i][3])
               _g.moveTo(_path[i][0], _path[i][1]);
            else
               _g.lineTo(_path[i][0], _path[i][1]);
         _g.stroke();
      }
   }

   function _g_fillText(str, x, y) {
      if (isAnimatingView) {
         var f = _g.font;
