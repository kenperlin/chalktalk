   ...
   var tick = function(g) {
      ...
      if (displayStrokes.isStereo) {
         ...
         if (server.headBuffer != null) {
            viewForwardMat.rotateX(server.headBuffer.rotation.x);
            viewForwardMat.rotateY(server.headBuffer.rotation.y);
            viewForwardMat.rotateZ(server.headBuffer.rotation.z);
            viewForwardMat.translate(
                  server.headBuffer.position.x,
                  server.headBuffer.position.y,
                  server.headBuffer.position.z);
         }
         viewForwardMat.translate(-width()/2, -height()/2, 0);
      }
