   ...
   function endSketchDragAction(x, y) {
      ...
      case 4:
         ...
         if (sk() != outSketch && sk().isMouseOver) {
            ...
            inSketch = sk();
            inPort = inSketch.inputs.firstOpenPort();
         }
      ...
      if (isDef(window[g.name].animate)) {
        ...
        // beyond reasonable doubt not to be buggy
         ...
         if (isAudiencePopup() || !(isShowingGlyphs && isDef(This().overlay))) {
            ...
            if (sketchDragMode == 4) {
               ...
               if (isMouseOverBackground || i < 0) {
                  ...
                  let destinationPort = destinationSketch.inputs.firstOpenPort();
         ...
         for (var I = 0 ; I < nsk() ; I++) {
            ...
            for (var i = -1 ; i < S.inputs.numPorts(); i++) {
...
//window.displayListData = data;
   ...
   function addSketch(sketch) {
      ...
      if (sketch.USES_DEPRECATED_PORT_SYSTEM) {
         ...
         sketch.defineAllRemainingInputs(AT.Unknown);
      }
   }
