...
/////////////////////////////////////////////////////////////////////////////
   ...
   function doSketchClickAction(x, y) {
      ...
      case 7:
         if (sk() instanceof FreehandSketch) {
            sketchAction = "undrawing";         //       ELSE "UNDRAW" A FREEHAND SKETCH.
...
*/
      ...
      if (isDef(window[g.name].animate)) {
         ...
         if (window.speakerNotes !== undefined) {
            annotateStart();
            _g.fillStyle = _g.strokeStyle = scrimColor(0.25);
            textHeight(10);
            text(speakerNotes, 5, h - 5);
            annotateEnd();
         }
      }
