	    ...
	    :                                            'crosshair'
         ...
         (function() {
            ...
            if (isShowingOverview || overviewAlpha > 0) {
               function xInOverview(x) { return (x - w/2) / overviewScale + w/2 - _g.panX; }
               function yInOverview(y) { return (y - h/2) / overviewScale + h/2 - _g.panY; }
               color(bgScrimColor(overviewAlpha));
