...
*/
      ...
      // TEMPORARY
      if (mouseInBottomLeftCorner()) {
         CT_SpeechToText.activate();
         CT_SpeechToText.focus();
      }
      else {
         CT_SpeechToText.deactivate();
      }
   }

   // TEMPORARY
   var mouseInBottomLeftCorner = function() {
      var mx = This().mouseX, my = This().mouseY;
      return mx < 10 - _g.panX && my > height() - 10 - _g.panY;
   };
