...
//    + " <input id='soundfileinput' type='file' style='visibility:hidden' /> </input>"
      ...
      console.log(isPhone() + ' ' + width() + ' ' + height());
...
/////////////////////////////////////////////////////////////////////
   ...
   function registerGlyph(name, strokes, indexName) {
      ...
      for (var i = 0 ; i < glyphs.length ; i++)
         if (indexName.toLowerCase() < glyphs[i].indexName.toLowerCase()) {
   ...
   function endSketchDragAction(x, y) {
      ...
      case 5:
         ...
         if (isDef(sk().cmdSwipe)) {
            sk().doCmdSwipe(pieMenuIndex(x - this.xCmdDown, y - this.yCmdDown, 8));
         }
