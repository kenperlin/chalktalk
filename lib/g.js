...
*/
   ...
   function drawWebClientIcon(i, name) {
      ...
      var r = 12;
      color(scrimColor(isMouseOverWebClientIcons ? 1 : 0.5, i));
   ...
   var isMouseOverWebClientIcons = false;
...
*/
      ...
      isMouseOverWebClientIcons = false;
      if (webClientList.size() > 1) {
         isMouseOverWebClientIcons = isOverWebClientIcons(This().mouseX, This().mouseY);
         annotateStart();
	 var i = 0;
         for (var name in webClientList.clients)
	 ...
	 if (isMouseOverWebClientIcons) {
	    broadcastEvent('requestFocus', time);
	 }
      }
   }
