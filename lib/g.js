...
var sketchDragY = 0;
   ...
   function endSketchDragAction(x, y) {
      ...
      case 4:
         ...
         i = outSketch.out_DEPRECATED_PORT_SYSTEM[outPort].length - 1;
         outSketch.out_DEPRECATED_PORT_SYSTEM[outPort][i].s = computeCurvature(outSketch.linkCurve);
...
*/
      ...
      isShowingToolTips = ! isTextMode && sketchPage.letterPressed == 'spc';
            ...
            if (sketchDragMode == 4) {
               ...
               if (isMouseOverBackground || i < 0) {
                  ...
                  if (destinationSketch === outSketch) {
                     ...
                     && destinationSketch.canAcceptInputWithType(outputType, destinationPort))
                  {
                     drawPossibleLink(outSketch, POSSIBLE_LINK_ARROW_HEAD);
                  }
                  else {
