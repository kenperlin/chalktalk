...
/////////////////////////////////////////////////////////////////////////////
   ...
   var tick = function(g) {
      ...
      if (isAnimatingView) {
         viewForwardMat.translate( width()/2,  height()/2, 0);
         viewForwardMat.rotateY(0.06);
         viewForwardMat.translate(10 * sin(20 * time), 10 * cos(13 * time), 0);
         viewForwardMat.rotateX(0.05 * sin(11 * time));
         viewForwardMat.translate(-width()/2, -height()/2, 0);
      }
      else
