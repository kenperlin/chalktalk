...
////////////////////////////////////////////////////////////////
   ...
   function initEventHandlers(canvas) {
      ...
      function broadcastEvent(type, x, y) {
         server.broadcastEvent(type + ',' + x + ',' + y);
      }
	 ...
	 switch (type) {
	 case 'mousedown': canvas.onmousedown(event, x, y); break;
	 case 'mouseup'  : canvas.onmouseup  (event, x, y); break;
	 case 'mousemove': canvas.onmousemove(event, x, y); break;
	 }
      }
