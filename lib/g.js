...
*/
   ...
   function addSketch(sketch) {
      ...
      sketch.sketchTexts = [];
      sketch.inputs = new InputPortList();
      ...
      sk().defaultValue_DEPRECATED_PORT_SYSTEM = [];
      sk()._faders.clear();
      sk().id = globalSketchId++;
      sk().in_DEPRECATED_PORT_SYSTEM = [];
      sk().inValue_DEPRECATED_PORT_SYSTEM = [];
      sk().isDrawingEnabled = false;
      sk().out_DEPRECATED_PORT_SYSTEM = [];
      sk().outValue_DEPRECATED_PORT_SYSTEM = [];
      sk().portBounds_DEPRECATED_PORT_SYSTEM = [];
      sk().portLocation_DEPRECATED_PORT_SYSTEM = [];
