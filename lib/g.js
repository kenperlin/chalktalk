...
/////////////////////////////////////////////////////////////////////////////
   ...
   function assignCollectionToSketch() {
      ...
      var sketch = sk();
      var trace = sketch.toTrace(sk().sp);
      trace.shift();
      addGlyph(id, trace);
      ...
      collections.push({id : id, trace : trace});
      server.set('state/collections', collections);
   }

   function addGlyph(id, trace) {
	       ...
	       // THEN LOAD THE COLLECTIONS INDEX.
               ...
               server.get('state/collections', function(value) {
                  ...
                  for (var i = 0 ; i < collections.length ; i++)
                     addGlyph(collections[i].id, collections[i].trace);
               });
         }
         lsRequest.send();
      }
...
*/
   ...
   function setMeshUpdateFunction(mesh) {
      mesh.update = function() {
         ...
         var alpha = S.fade() * (isDef(S.alpha) ? S.alpha : 1);
