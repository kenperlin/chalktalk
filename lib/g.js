...
/////////////////////////////////////////////////////////////////////////////
   ...
   function startSketchDragAction(x, y) {
      ...
      case 2:
         ...
         break;
      case 3:
         console.log("start sketch copy drag action");
         var tX = sk().tX;
         var tY = sk().tY;
         copySketch(sk());
         sk().tX = tX;
   ...
   function doSketchDragAction(x, y) {
      ...
      case 2:
         ...
         break;
      case 3:
         console.log("do sketch copy drag action");
         ...
         if (! isVerticalPan) {
            if (isRightHover) {
               ...
               for (var pn = 0; pn < sketchPages.length; pn++) {
                  ...
                  _g.font = pageNumber == pn ? '14px Arial' : '10px Arial';
                  ...
                  _g.fillText(pn, numberX, (pn + (pageNumber == pn ? 1.1 : 0.9)) * numberSpacing);
               }
