...
///////// SAVING / LOADING THE PAGE TO / FROM THE SERVER //////////
      ...
      serialize : function () {
         ...
         for (n = 0 ; n < nsk() ; n++) {
            if ((out = sk(n).outLinks[0]) !== undefined)
...
//////////////////////////////////////////////////////////////
      ...
      createLink : function(inSketch, inPort, outSketch, outPort) {
         ...
         if (inPort >= inSketch.inLinks.length
            || inSketch.inLinks[inPort] === undefined
            || inSketch.inLinks[inPort].a != outSketch
            || inSketch.inLinks[inPort].i != outPort)
         {
