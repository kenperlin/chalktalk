...
//////////////////////////////////////////////////////////////
      ...
      createLink : function() {
         ...
         if (inPort >= inSketch.in_DEPRECATED_PORT_SYSTEM.length || inSketch.in_DEPRECATED_PORT_SYSTEM[inPort] === undefined
...
var isSpeakerNotes = false;               // imageLibrary sketchPage
var showingLiveDataMode = 0;              // g
...
var speakerNotes;                         // g imageLibrary
