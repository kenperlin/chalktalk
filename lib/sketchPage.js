...
///////// SAVING / LOADING THE PAGE TO / FROM THE SERVER //////////
      ...
      serialize : function () {
         ...
         for (n = 0 ; n < nsk() ; n++) {
            if ((out = sk(n).output.links) !== undefined)
	...
	this._linksFromData(sketchData[1]);
      ...
      _linksFromData : function(d, di) {
         if (di === undefined)
            di = 0;
         for (var n = 0 ; n < d.length ; n++)
            new SketchLink(sk(di+d[n][0]), sk(di+d[n][1]), d[n][2], d[n][3]);
      },
...
//////////////////////////////////////////////////////////////
      ...
      createLink : function(inSketch, inPort, outSketch) {
         ...
         {
            ;
            return new SketchLink(outSketch, inSketch, inPort);
         }
