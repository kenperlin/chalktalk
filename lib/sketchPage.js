...
//////////////////////////////////////////////////////////////
      ...
      createLink : function(inSketch, inPort, outSketch, outPort) {
         ...
         if (!inSketch.canAcceptInputOfType(outSketch.getOutputType(), inPort)) {
            return false;
         }
      ...
      animate : function(elapsed) {
         ...
         if (! this.isCTObject) {
            ...
            if (! this.ctObject) {
               ...
               var N = new Noise();
               this.ctObject.add(new CT.Parametric(20,20,function(u,v){return[2*u-1,2*v-1,.5*N.noise([3*u,3*v,.5])];}));
