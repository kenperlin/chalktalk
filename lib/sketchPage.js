...
///////////////////// EVENT HANDLERS /////////////////////////
	 ...
	 if (! isTextMode && isk() && isHover() && key >= 48 && key <= 48 + 9) {
	    ...
	    if (imageLibrary_index >= 0) {
	       imageLibrary_index = (imageLibrary_images.length + imageLibrary_index - 1) % imageLibrary_images.length;
	    ...
	    if (imageLibrary_isVisible)
	       imageLibrary_isVisible = false;
	    else if (! isHover() && imageLibrary_index >= 0)
	       imageLibrary_alpha = imageLibrary_alpha == 1 ? .99 : 1;
            break;
         case 'alt':
...
// DRAW ALL THE SKETCHES.
         ...
         for (var I = 0 ; I < nsk() ; I++) {
            ...
            // WHILE RENDERING IT, TEMPORARILYMAKE THIS SKETCH THE SELECTED SKETCH.
