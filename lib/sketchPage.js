...
//////////////////////////////////////////////////////////////
	 ...
	 if (this.isHMDTracking && server.headBuffer) {
	    ...
	    ctScene.setViewMatrix( CT.matrixMultiply(pq2m([ p.x, p.y, p.z,  q.x, q.y, q.z, q.w ]),
	                                             this.cameraDistanceMatrix) );
	 }
	 else {
	    var a = isCTRotate * time / 3, c = cos(a), s = sin(a), fl = ctScene.getFL();
...
// DRAW ALL THE SKETCHES.
         ...
         for (var I = 0 ; I < nsk() ; I++) {
            ...
            if (sketch.sketchTrace != null && sketch.sketchState != 'finished') {
               ...
               if (sketch.glyphTransition >= (sketch._isModel ? .5 : 1)) {
