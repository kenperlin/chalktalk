...
// UNDER CONSTRUCTION >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
   ...
   // I'll see
   function skStateRecord(numFutureStates) {
      // reserve one more space for the empty state     
      this.size = numFutureStates + 2;
      this.queue = [];
      for (var i = 0; i < this.recordCap; i++) {
        this.queue.push([]);
      }
   ...
   skStateRecord.prototype.saveState = function(sp) {
      ...
      var next = (this.curr + 1) % this.size;
      if (next == this.start) {
         this.queue[this.start].length = 0;
   ...
   skStateRecord.prototype.undo = function(sp) {
      // no-op
      if (((this.curr - 1) < 0 && this.size - 1 == this.start)
            || ((this.curr - 1) % this.size == this.start)) {
         return;
      }
      this.curr = ((this.curr - 1) < 0) ? this.size - 1 : this.curr - 1;
   }
   ...
   skStateRecord.prototype.redo = function(sp) {
      // no-op
      if (((this.curr - 1) < 0 && this.size - 1 == this.future)
              || ((this.curr - 1) % this.size == this.future)) {
            return;
      }
   ...
   skStateRecord.prototype.restoreState = function(sp) {
      ...
      var state = this.queue[
         ((this.curr - 1) < 0) ? this.size - 1 : this.curr - 1
      ];
