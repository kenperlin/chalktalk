...
// THE SKETCH BOOK CONTAINS ALL THE SKETCH PAGES.
   ...
   function computeStandardView() {
      ...
      m._xf_(sk().viewInverseMat._m())
      m._xf_(viewForwardMat._m())
   ...
   function computeStandardViewInverse() {
      ...
      m._xf_(viewInverseMat._m())
      m._xf_(sk().viewForwardMat._m())
...
case 'a':
   isAnimatingView = ! isAnimatingView;
/*
   var dx = viewForwardMat._m()[12] > 0.5 ? -1 : 1;
   viewForwardMat.translate(dx,0,0);
