...
// MOST USER INTERACTION IS MEDIATED BY THE CURRENT SKETCH PAGE.
   ...
   function SketchPage() {
      ...
      // TEST
      this.skStates = new StateQueue(8);
   }
...
///////////////////// EVENT HANDLERS /////////////////////////
      ...
      keyDown : function(key) {
         ...
         console.log(this.skStates.queue);
         switch (letter) {
         case '3': case 'alt':
            isAltPressed = true;
            return;
         ...
         case 'z':
            this.sketches = [];
            this.unpackSketches2(savedStateZ);
            break;
         case 'x':
            this.sketches = [];
            this.unpackSketches2(savedStateX);
            break;
         case 's':
            savedStateZ = this.serialize();
            break;
         case 'd':
            savedStateX = this.serialize();
            break;
         case '2': case 'm':
         case '4': case 's':
