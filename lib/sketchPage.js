...
//////////////////////////////////////////////////////////////
      ...
      animate : function(elapsed) {
         ...
         if (this.isHMDTracking && server.headBuffer) {
            ...
            ctScene.setViewMatrix( CT.translate(CT.rotateY(CT.matrixTranslated(0,0,-fl), isCTRotate * time), 0,0,fl) );
         }
         ...
         if (! isCTObject) {
		  ...
		  ,'}'
            ...
            CT.time = time;
            var t = time;
            ctObject.identity().translate(0,0,-ctScene.getFL()).scale(.08);
            for (var i = 0 ; i < ctObject.numChildren() ; i++)
               ctObject.getChild(i).identity().translate(6*(i%4)-10, i<4?2:-2, 0).rotateY(t).rotateX(t/2);
            ctObject.getChild(0).identity().translate(0, 5 * sin(3 * t), 0).rotateY(t);
