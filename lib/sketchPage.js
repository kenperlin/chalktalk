...
function moveSketchToPageAtIndex(sketch, dstPageIndex) {
   const currPageSketches = sketchPages[pageIndex].sketches;

   let index = currPageSketches.indexOf(sketch);
   if (index !== -1) {
      console.log("moving sketch from: " + pageIndex + " to " + ((pageIndex + 1) % sketchPages.length));
...
function moveGroupToPageAtIndex(groupObj, dstPageIndex) {
