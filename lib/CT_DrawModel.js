...
CT.createDrawFunction = function(type) {
   eval('CT.Object.prototype.draw' + type + ' = function(a,b,c,d,e,f) { return this._drawChild("' + type + '",a,b,c,d,e,f); }');
   eval('window.m' + type + ' = function(a,b,c,d,e,f) {\
      sk()._isModel = true;\
...
CT.Object.prototype._drawChild = function(type, a, b, c, d, e, f) {
   ...
   if (! child || child._draw_hash != hash) {
      ...
      eval('child = new CT.' + type + '(a,b,c,d,e,f)');
