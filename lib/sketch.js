...
Sketch.prototype = {
   ...
   defineOutput: function(type, outputFunc) {
      if (!AT.typeIsDefined(type)) {
         console.error("Typename " + type.name + ", used as output for " + this.label
            + ", not defined");
         return;
      }
   ...
   // TODO: consider de-stringly-typing this
   ...
   canAcceptInputOfType: function(inputValueTypename, inputPortNumber) {
      ...
      if (this.USES_DEPRECATED_PORT_SYSTEM) {
         ...
         return AT.canConvert(inputValueTypename, AT.Unknown);
      }
      else {
...
function FreehandSketch() {
   ...
   this.init = function() {
      this.defineInput("String");
      this.defineAlternateInputType("Unknown", function(unk) { return valueToString(unk.value); });
   }
