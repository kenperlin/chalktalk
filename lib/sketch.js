...
Sketch.prototype = {
   ...
   delete : function() {
      ...
      if (i >= 0) {
         ...
         if (this.in_DEPRECATED_PORT_SYSTEM.length > 0 && isDef(this.in_DEPRECATED_PORT_SYSTEM[0])) {
            ...
            if (outPortIndex >= 0) {
               var outLinks = this.out_DEPRECATED_PORT_SYSTEM[outPortIndex];
   ...
   hasPortBounds : function(i) {
      return this.portBounds_DEPRECATED_PORT_SYSTEM[i] !== undefined && isNumeric(this.portBounds_DEPRECATED_PORT_SYSTEM[i][0]);
   },
   ...
   isDefaultValue : function(name) {
      ...
      return j >= 0 ? isDef(this.defaultValue_DEPRECATED_PORT_SYSTEM[j]) : false;
   },
   isInValue : function(name) {
      return this.isInValueAt(getIndex(this.portName_DEPRECATED_PORT_SYSTEM, name));
   },
   ...
   setDefaultValue : function(name, value) {
      var j = getIndex(this.portName_DEPRECATED_PORT_SYSTEM, name);
      if (j >= 0) {
         this.defaultValue_DEPRECATED_PORT_SYSTEM[j] = value;
         if (this.defaultValueIncr_DEPRECATED_PORT_SYSTEM[j] === undefined)
            this.defaultValueIncr_DEPRECATED_PORT_SYSTEM[j] = 1;
      }
   },
