...
Sketch.prototype = {
   ...
   clone : function() { // TODO : CLEAN
   
            var cloneObject = function() {};
            var cloneArrayWithSelfRef = function() {};
            function isGetterOrSetter(obj, prop) {
               ...
               return {
                  yes : (descriptor['get'] !== undefined || 
                         descriptor['set'] !== undefined), 
                  descriptor : descriptor
               };
            }
            
            var ignoredArraysDuringCopy = [
               "children",
               /*"defaultValue",*/
               "in",
               "inValue",
            ...
            cloneObject = function(obj, selfRef, selfCopy = undefined) {
               ...
               for (var prop in obj) {
                  const result = isGetterOrSetter(obj, prop);
                  if (result.yes) {
                     Object.defineProperty(Object.getPrototypeOf(dst), prop, result.descriptor);
                  }
            ...
            cloneArrayWithSelfRef = function(src, dst, selfRef, selfCopy) {
               if (src === undefined) {
                  return undefined;
               }
               if (dst === undefined) {
