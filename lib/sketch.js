...
Sketch.prototype = {
   ...
   defineInput: function(typename) {
      ...
      if (isDef(this.inputs)) {
         this.inputs._addPort(new InputPort(typename))
      }
   },
   ...
   defineAlternateInputType: function(typename) {
      if (!AT.typeIsDefined(typename)) {
      ...
      if (isDef(this.inputs)) {
         ...
         this.inputs.port(i).addAcceptedType(typename);
      }
   },
   ...
   drawText : function(context) {
            ...
            || this.inputs.hasValue(0)))
      {
         ...
         if (this.inputs.hasValue(0)) {
            // The conversion system should have already made this an Atypical string
            str = this.inputs.value(0).str;
         }
         else {
