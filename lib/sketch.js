...
Sketch.prototype = {
   ...
   drawText : function(context) {
      ...
      if (this instanceof FreehandSketch && this.isNullText() && isDef(this.inValue_DEPRECATED_PORT_SYSTEM[0])) {
         var str = this.stringifyData(valueOf(this.inValue_DEPRECATED_PORT_SYSTEM[0], time));
...
function FreehandSketch() {
   ...
   this.mouseDown = function(x, y) {
      ...
      if (this.text.length > 0 && ! isDef(this.inValue_DEPRECATED_PORT_SYSTEM[0]))
         return;
...
function NumericSketch() {
   ...
   this.render = function() {
      ...
      var value = this.inValue_DEPRECATED_PORT_SYSTEM[0];
      if (isDef(value)) {
