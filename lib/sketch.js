...
Sketch.prototype = {
   ...
   outSketch : function(port) {
      var links = this.output.links;
      return ! links || ! links[port] ? null : links[port].b;
   },
   ...
   //       defined. If you want to accept multiple different types, use AnyOf(...)
   ...
   //
   // You CAN pass in an AnyOf(...) type to this function to accept multiple types.
   //
...
function FreehandSketch() {
   ...
   FreehandSketch.inputType = AT.AnyOf(AT.Expression, AT.String, AT.Unknown);

   this.init = function() {

      this.defineAllRemainingInputs(FreehandSketch.inputType,
         function(value) {
