...
Sketch.prototype = {
   ...
   drawStretchValues : function() {
      ...
      var sr = 50, dy = sr / 2, font = floor(.6 * dy) + 'pt Arial';
	 ...
	 t = t * t;
      ...
      if (sketchDragMode == 7)
         sketchPage.iStretch = nKeys == 1 ? 0 : floor(max(0, min(nKeys-1, (this.cy() - sketchPage.y) / dy + 1.5)));
