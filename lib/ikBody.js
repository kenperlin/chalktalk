...
(function() {
   var p = 'NECK ANKLE_R ANKLE_L WRIST_L WRIST_R KNEE_R KNEE_L ELBOW_L ELBOW_R BELLY_R BELLY_L HIP_R HIP_L SHOULDER_R SHOULDER_L'.split(' ');
   window.IK = {};
...
IKBody.prototype = {
   ...
   computeNodeData : function() {
      ...
      nodeP[IK.BELLY_R   ] = relVec(IK.NECK      ,-0.1 , -0.19, 0);
      nodeP[IK.BELLY_L   ] = relVec(IK.NECK      , 0.1 , -0.19, 0);

      nodeP[IK.HIP_R     ] = relVec(IK.BELLY_R   ,-0.02, -0.15, 0);
      nodeP[IK.KNEE_R    ] = relVec(IK.HIP_R     , 0   , -0.36, 0);
      nodeP[IK.ANKLE_R   ] = relVec(IK.KNEE_R    , 0   , -0.34, 0);

      nodeP[IK.HIP_L     ] = relVec(IK.BELLY_L   , 0.02, -0.15, 0);
      nodeP[IK.KNEE_L    ] = relVec(IK.HIP_L     , 0   , -0.36, 0);
      nodeP[IK.ANKLE_L   ] = relVec(IK.KNEE_L    , 0   , -0.34, 0);

      nodeP[IK.SHOULDER_R] = relVec(IK.NECK      ,-0.15,  0.1 , 0);
      nodeP[IK.ELBOW_R   ] = relVec(IK.SHOULDER_R,-0.22,  0   , 0);
      nodeP[IK.WRIST_R   ] = relVec(IK.ELBOW_R   ,-0.20,  0   , 0);

      nodeP[IK.SHOULDER_L] = relVec(IK.NECK      , 0.15,  0.1 , 0);
   ...
   getLinkData : function() {
      return [
	 [IK.HIP_L  , IK.HIP_R  ], [IK.BELLY_L, IK.BELLY_R, .9],
	 ...
	 [IK.NECK      , IK.SHOULDER_L],
	 [IK.NECK      , IK.SHOULDER_R],
	 [IK.BELLY_L   , IK.SHOULDER_L],
	 [IK.BELLY_R   , IK.SHOULDER_R],
	 [IK.BELLY_L   , IK.SHOULDER_R, 0.5],
	 [IK.BELLY_R   , IK.SHOULDER_L, 0.5],
   ...
   modelBody : function() {
	 ...
	 case IK.ANKLE_L:
	    ...
	    joint.position.set(0,-.03,0);
	    joint.scale.set(.035,.07,.045);
