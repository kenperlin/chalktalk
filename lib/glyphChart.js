...
GlyphChart.prototype = {
   ...
   color : function() {
      return backgroundColor == 'white' ? 'rgb(0,50,100)' : 'rgb(128,192,255)' ;
   },
   scrim : function() {
     return fadedRGB(backgroundColor == 'white' ? 0.3 : 0.1, [0,128,255]);
   },
   bounds : function(i) {
