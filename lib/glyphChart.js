...
GlyphChart.prototype = {
   ...
   tagActiveColor : "green",
   tagColorOnActivate : "green",
   tagColorOnDeactivate : "red",
   ...
   drawTagList : function() {
      ...
      function drawTag(i) {
         ...
         let stroke = defaultPenColor;
         if (isSelected) {
            if (isClicked) {
               stroke = (isActive) ? that.tagColorOnActivate : that.tagColorOnDeactivate;
            }
            else {
            ...
            stroke = (isActive) ? that.tagActiveColor : that.color();
         }
