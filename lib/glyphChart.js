...
GlyphChart.prototype = {
   ...
   tagBounds : function(i) {
      ...
      var x = width() - (txtLen * 10) - _g.panY - 400;
   ...
   drawTagList : function() {
      ...
      function drawTag(i) {
         ...
         var isClicked = that.isClicked && that.isSelectingTag && i == that.iSelectedTag;
         if (isClicked) {
   ...
   drawGlyph : function(i, cx, cy) {
      ...
      var isHighlighted = isSelected ||
                         ( maskNZ && (highlightedByTag || this.numActiveTags == 0) ) ||
                         ( !maskNZ && (highlightedByTag) );
