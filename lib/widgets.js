...
////////////////////////////// CODE TEXT EDITOR //////////////////////////////////
   ...
   function codeScript() {
      return sketchFileData[codeSketch.typeName][1];
   }
   function code() {
   ...
   function codeSelectorFgColor() {
      ...
      return backgroundColor === 'white' ? bgScrimColor(codeSketch.fadeAlpha())
                                         : 'rgba(192,224,255,' + codeSketch.fadeAlpha() + ')';
   }
   ...
   function codeTextFgColor() {
      if (codeIsBook()) return 'black';
      return (backgroundColor == 'white' ? 'rgba(0,112,224,' : 'rgba(128,192,255,') + codeSketch.fadeAlpha() + ')';
   }
