...
// POSITION AND SIZE OF THE COLOR PALETTE ON THE UPPER LEFT OF THE SKETCH PAGE.
   ...
   function paletteWidth() { return 32; }
   function paletteHeight() { return paletteY(palette.length) - 10; }
   function paletteX(i) { return 20 - _g.panX; }
   function paletteY(i) { return 20 + i * 30 - _g.panY; }
   function paletteR(i) {
