...
,'      float trb2 = turbulence(vec3(mndx*23., mndy*23., floor(time*28.0)));'
,'      // float sin1 = sin(ndx * 2.0 * 3.14159 + time);' 
,'      //'
,'      float cycle_time = 15.0;'
,'      float cycle_one = 5.0;'
,'      float cycle_two = 15.0;'
...
,'      if (cycle_num == 1.0) spot_amp *= step(0.2, trb1);'
,'      if (cycle_num == 2.0) spot_amp *= step(0.2, trb2);'
