...
function() {
   ...
   this.output = function() {
      ...
      if (this.inValue_DEPRECATED_PORT_SYSTEM[0] instanceof AT.Type) {
         if (this.inValue_DEPRECATED_PORT_SYSTEM[0] instanceof AT.Bool) {
            return this.inValue_DEPRECATED_PORT_SYSTEM[0];
         }
         else {
            let converted = this.inValue_DEPRECATED_PORT_SYSTEM[0].convert("Bool");
